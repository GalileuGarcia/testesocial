...
<div class="container" x-data="{ rightSide: false, leftSide: false }" style="width: 80%;">
            ...
            <div class="timeline">
                    ...
                    <div class="intro box">
                        ...
                        <div class="info">
                            ...
                            <div class="info-item">
                                ...
                                Player name <a href="#"><?= $this->session->userdata('usuario')['nome']; ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="event box">
                ...
                <div class="timeline-right">
                    <div class="status box">
                        ...
                        <div class="status-main">
                            <img src="https://images.genius.com/2326b69829d58232a2521f09333da1b3.1000x1000x1.jpg" class="status-img">
                                ...
                                <textarea class="status-textarea" placeholder="Write something to <?= $this->session->userdata('usuario')['nome']; ?>..."></textarea>
                    ...
                    <?php foreach ($postagens as $post) { ?>
                        <div class="album box">
                            <div class="status-main">
                                ...
                                <div class="album-detail">
                                    <div class="album-title"><strong><?= $post->nome ?></strong> create new <span>album</span></div>
                            ...
                            <div class="album-actions">
                                <a href="#" class="album-action curtida" data-id="<?= $post->id_post ?>">
                                    <svg stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24" id="svg<?= $post->id_post ?>">
                                        <path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z" />
                                    </svg>
                                    <span id="like<?= $post->id_post ?>"><?= $totCurt = $ctrl->curtidasPost($post->id_post); ?> </span>
                                </a>
                                <a href="#" class="album-action comentario-social" data-id="<?= $post->id_post ?>">
                                    ...
                                    <span id="comentarios<?= $post->id_post ?>"><?= $totComment = $ctrl->comentariosPost($post->id_post); ?> </span>
                                </a>
                            ...
                            <hr>
                                <div class="anim">
                                    <div id="com<?= $post->id_post ?>" style="padding: 8px 20px 0px"></div>

                                    <div class="comentarios-box<?= $post->id_post ?> hide" style="padding: 8px 20px 15px">
                                        <form id="comment-form<?= $post->id_post ?>" class="comentarios-form">
                                            <div class="form-group">
                                                <textarea class="form-control status-box" rows="2" name="comentario" placeholder="Escreva um comentário"></textarea>
                                            </div>
                        ...
                        <script>
                            $('body').delegate('#comment-form<?= $post->id_post ?>', 'submit', function (e) {
                                e.preventDefault();
                                $.ajax({
                                    data: $("#comment-form<?= $post->id_post ?>").serialize(),
                                    type: "POST",
                                    dataType: 'json',
                                    url: 'Postagem/enviaComentario',
                                    success: function (data) {
                                        if (data['situacao'] == true) {
                                            $('#comment-form<?= $post->id_post ?>').each(function () {
                                                this.reset();
                                            });
                                            $("#com" + data['post']).html('');
                                            ...
                                            $("#comentarios" + data['post']).text(data['comentarios']);
    ...
    <div class="right-side" :class="{ 'active': rightSide }">
        <div class="account">
            ...
            <span class="account-user"><?= $this->session->userdata('usuario')['nome']; ?>
